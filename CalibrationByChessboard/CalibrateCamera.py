...
CHESSBOARD_CORNERS_ROWCOUNT = 13
...
images = glob.glob('D:\Daten\Johannes\VScode\opencv-examples\CalibrationByChessboard\Tisch5_20240828.png')
...
f = open('calibrationWdCam2.pckl', 'wb')
pickle.dump([cameraMatrix, distCoeffs, rvecs, tvecs], f)
f.close()
    
# Print to console our success
print('Calibration successful. Calibration file used: {}'.format('calibrationWdCam2.pckl'))
