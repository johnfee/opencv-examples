...
CHESSBOARD_CORNERS_ROWCOUNT = 14
CHESSBOARD_CORNERS_COLCOUNT = 9
...
images = glob.glob('/home/johannes/Github/opencv-examples/distorted_chessboard_pattern_centered.png')
...
f = open('calibrationHdUwdCam2.pckl', 'wb')
pickle.dump([cameraMatrix, distCoeffs, rvecs, tvecs], f)
f.close()
    
# Print to console our success
print('Calibration successful. Calibration file used: {}'.format('calibrationHdUwdCam2.pckl'))
